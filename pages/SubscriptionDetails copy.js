...
const subscription_group = "syntrafit_monthly_0";

// Define your product IDs as set in your app store configuration.
const productIds = [
  "syntrafit_sub_monthly_0",
  "syntrafit_sub_yearly_pro_0"
...
const ProSubscriptionScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const initIAP = async () => {
      try {
        ...
        //const subscriptions = await RNIap.getProducts(productIds );
  ...
  const getProductId = () => {
    ...
    return isYearly ? "premium_yearly" : "syntrafit_sub_monthly_0";
  };
